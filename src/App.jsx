...
export default function InvoiceApp() {
  ...
  useEffect(() => {
    ...
    try {
      const payload = JSON.stringify({ entries, companies, sitePresets, namePresets, ninkuPresets, comboPresets, routes, profile, paymentStatus });
  ...
  }, [entries, companies, sitePresets, namePresets, ninkuPresets, comboPresets, routes, profile, paymentStatus, loading]);
