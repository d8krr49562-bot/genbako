            ...
            <div style={{ marginTop: 10, background: "#242832", border: "1px solid #333846", borderRadius: 12, padding: 12 }}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                <LabeledField label="距離(km)">
                  <input type="text" inputMode="numeric" value={routeKmStr} placeholder="0" onChange={(e) => setRouteKmStr(e.target.value.replace(/[^0-9.]/g, ""))} style={inputStyle} />
                </LabeledField>
                <LabeledField label="1kmあたり(円)">
                  <input type="text" inputMode="numeric" value={ratePerKmStr} placeholder="20" onChange={(e) => setRatePerKmStr(e.target.value.replace(/[^0-9.]/g, ""))} style={inputStyle} />
                </LabeledField>
              </div>
