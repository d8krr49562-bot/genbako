              ...
              {highways.map((h) => (
                <div key={h.id} style={{ background: "#242832", border: "1px solid #333846", borderRadius: 12, padding: 12 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 10, flexWrap: "wrap" }}>
                    ...
                    />
                    <span style={{ color: "#8A8F9C", fontSize: 12 }}>IC</span>
                    <button onClick={() => removeHighway(h.id)} style={{ background: "none", border: "none", cursor: "pointer", padding: 2, marginLeft: "auto" }}>
                      <Trash2 size={15} color="#5A5F6B" />
                    </button>
                  </div>
                ...
                {p.highways.map((h) => (
                  <div key={h.id} style={{ background: "#242832", border: "1px solid #333846", borderRadius: 10, padding: 10 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8, flexWrap: "wrap" }}>
                      ...
                      <span style={{ color: "#8A8F9C", fontSize: 12 }}>IC</span>
                      <button onClick={() => removePersonHighway(p.id, h.id)} style={{ background: "none", border: "none", cursor: "pointer", padding: 2, marginLeft: "auto" }}>
                        <Trash2 size={14} color="#5A5F6B" />
                      </button>
                    </div>
                    <div style={{ display: "flex", gap: 8, alignItems: "flex-end" }}>
